...
- [ ] 6.1 Create `frontend/src/api/doctors.api.ts` list(query)
- [ ] 6.2 Create `frontend/src/api/admin.api.ts` metrics(), prescriptions()
- [ ] 6.3 Create `frontend/src/stores/admin.store.ts` metrics + presc list + filters
