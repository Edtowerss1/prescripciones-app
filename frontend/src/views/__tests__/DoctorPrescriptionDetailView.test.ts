...
import DoctorPrescriptionDetailView from '@/views/doctor/DoctorPrescriptionDetailView.vue'
...
describe('DoctorPrescriptionDetailView', () => {
  beforeEach(() => {
  ...
  it('shows "Prescription not found" on 404 response', async () => {
    ...
    const wrapper = mount(DoctorPrescriptionDetailView)
    await flushPromises()
  ...
  it('shows loading spinner while fetching', async () => {
    ...
    // Loading spinner should be visible when the promise never resolves
